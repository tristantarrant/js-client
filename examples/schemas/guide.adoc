...
:keywords: schema,protobuf,protostream,metadata,register,retrieve,javascript
:duration: 5
:source-dir: examples/schemas
...
* link:../query/guide.html[Ickle queries] for querying data using registered schemas
