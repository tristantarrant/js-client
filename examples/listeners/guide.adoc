...
:keywords: listener,events,create,modify,remove,notifications,javascript
:duration: 10
:source-dir: examples/listeners
...
[source,shell]
----
node examples/listeners/main.js
----
...
* link:../near-cache/guide.html[Near caching] for client-side caching with server invalidation
