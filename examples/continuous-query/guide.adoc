...
:keywords: continuous-query,ickle,protobuf,protostream,listener,javascript
:duration: 15
:source-dir: examples/continuous-query
...
[source,shell]
----
node examples/continuous-query/main.js
----
...
* link:../query/guide.html[Ickle queries] for one-shot query operations
* link:../listeners/guide.html[Event listeners] for basic cache event listeners
